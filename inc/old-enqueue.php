...
// We're going to do it this way: (see below)
...
function _loa_scripts() {
  ...
  if(!is_admin()){
    ...
    wp_register_script( '_loa-main', get_template_directory_uri() . '/js/main.min.js', array('jquery-core'), '', true );
    wp_enqueue_script( '_loa-main' );
  }
...
add_action( 'wp_enqueue_scripts', '_loa_scripts', 999 );
...
//     // Only on stage
//     if( !strpos($_SERVER['SERVER_NAME'], 'dylanjharris.net') ){
